...
class MainScheduleForm(forms.Form):
    
    
    
    text = forms.CharField(
        widget=forms.TextInput(attrs={"placeholder":"Assignment name", "cols":3})
        )
    ...
    def __init__(self, data=None, files=None, **kwargs):
        super(MainScheduleForm, self).__init__(data, files, kwargs)
